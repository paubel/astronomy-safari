...
!(function () {
  ...
  function a(t, e) {
    ...
    return e
      ? ((i = t[0]),
        ...
        (o = e[2]),
        (a =
          Math.sin(l) * Math.sin(s) - Math.cos(l) * Math.cos(s) * Math.cos(i)),
        Math.abs(a) < 1e-5 &&
          (a =
  ...
  function L(t) {
    ...
    function o() {
      ...
      if (t && e) {
        ...
        return (
          (m.center[2] = isNaN(r) ? 0 : r), "" !== t.value && "" !== e.value
        );
      }
    }
    function i(t) {
    ...
    function h() {
      d3.selectAll(
        J + " ~ #celestial-form input, " + J + " ~  #celestial-form select"
      ).each(function (t, e) {
        if (void 0 !== this) {
          var a = this.id;
          if ("lat" === a || "lon" === a)
            z(m.geopos) &&
              (this.value = "lat" === a ? m.geopos[0] : m.geopos[1]);
    ...
    (T = 0),
      ...
      (j = F.map(function (t, e) {
        return (
          t === m.lang && (T = e),
          { o: t, n: zt.constellations[m.culture].names[t] }
        );
      })),
  ...
  function D(t) {
    ...
    switch (a) {
      ...
      case "stars-designation":
        for (
          e = !W("stars-designation").checked || !W("stars-show").checked,
            n = 0;
      ...
      case "dsos-names":
        for (
          e = !W("dsos-names").checked || !W("dsos-show").checked, n = 0;
      ...
      case "planets-names":
        for (
          e = !W("planets-names").checked || !W("planets-show").checked, n = 0;
    ...
    function c(t, e) {
      if (t && k(y, "settimezone") && !1 !== y.settimezone) {
        var a = Math.floor(h.getTime() / 1e3),
          n =
            window && "https:" === window.location.protocol ? "https" : "http",
          s =
            n +
        ...
        if (A.length > 1) {
          ...
          var L = M.append("select")
            ...
            F = A.map(function (t, e) {
              return (
                t === y.planets[j + "Type"] && (q = e), { o: t, n: S[j][t] }
              );
            });
          L.selectAll("option")
            .data(F)
      ...
      E.constellations.bounds &&
        X.defer(function (t) {
          d3.json(N + s("constellations", "borders"), function (e, a) {
            ...
            var n = o(a, E.transform);
            if (tt.constellation)
              var r = new RegExp("\\b" + tt.constellation + "\\b");
            Y.constBoundaries
              .selectAll(".bounds")
              .data(n.features)
              .enter()
              ...
              .attr("class", function (t) {
                return tt.constellation && -1 !== t.ids.search(r)
                  ? "constBoundariesSel"
                  : "constBoundaries";
              })
              .attr("d", Z),
            ...
            E.stars.designation &&
              (Y.starDesignations
                ...
                .data(
                  s.features.filter(function (t) {
                    return (
                      t.properties.mag <= E.stars.designationLimit * W &&
              ...
              E.stars.propername &&
                (Y.starNames
                  ...
                  .data(
                    s.features.filter(function (t) {
                      return (
                        t.properties.mag <= E.stars.propernameLimit * W &&
                        1 === a(t.geometry.coordinates)
                      );
                    })
                  )
                    ...
                    return (
                      ...
                      ((999 == t.properties.mag &&
                        Math.sqrt(parseInt(t.properties.dim)) >
                          E.dsos.nameLimit) ||
                        (999 != t.properties.mag &&
                          t.properties.mag <= E.dsos.nameLimit))
                    );
                  })
                )
                .enter()
          ...
          if (
            (tt.container.selectAll(".planet").each(function (t) {
              ...
              (l.ephemeris.pos = e(l.ephemeris.pos, gt[E.transform])),
                1 === a(l.ephemeris.pos) &&
                  ("lun" === r ? i.features.push(I(l)) : o.features.push(I(l)));
            }),
              ...
              ? Y.planets
                  ...
                  .attr("d", function (t) {
                    var e = k(E.planets.symbols[t.id], "size")
                      ? (E.planets.symbols[t.id].size - 1) * W
                      : null;
    ...
    ((tt.display = function (a) {
      ...
      function m(e) {
        ...
        if (a) {
          ...
          (Bt.clip == a.clip && !0 !== $.disableAnimations) || (c = 0),
            O(a.clip);
          var u = tt
              .projection(e.projection)
              .center(r)
          ...
          return o > i[0]
            ...
            : (($.location || $.formFields.location) &&
                (F("horizon-show", a.clip), F("daylight-show", !a.clip)),
              (Y = t(l, u)),
              ($.adaptable = !1),
              d3
                .select({})
            ...
            qt.selectAll(J + " .graticule_lon").each(function (t, e) {
              if (S(t.geometry.coordinates)) {
                ...
                vt(a, t.properties.orientation),
                  ee.fillText(t.properties.value, a[0], a[1]);
              }
            })),
          k($.lines.graticule, "lat") &&
              ...
              if (S(t.geometry.coordinates) && E(t.properties, $.dsos.limit)) {
                ...
                k($.dsos.symbols[a], "stroke") ? ee.stroke() : ee.fill(),
                  $.dsos.names &&
                    ...
                    (j($.dsos.nameStyle),
                    !0 === $.dsos.colors &&
                      (ee.fillStyle = $.dsos.symbols[a].fill),
      ...
      function A(t, e) {
        var a, n, r, s;
        if (t > 1.885)
          return (ee.fillStyle = "transparent"), void (ee.globalAlpha = 0);
        t <= 1.36
          ? ((n = "#daf1fa"),
            (r = "#93d7f0"),
            (s = "#57c0e8"),
      ...
      if (Bt) {
        ...
        (Q = d3.geo.path().projection(Y).context(ee)),
          ...
          (this.resize = function (t) {
            return (
              void 0 !== t &&
                (k(t, "width") ? ($.width = t.width) : x(t) && ($.width = t)),
              f(!0),
              $.width
            );
          }),
  ...
  var vt = function (t, e, a) {
    ...
    var s = e[1] * yt,
      o = a[0] * yt,
      i = Math.asin(
        Math.sin(s) * Math.sin(o) + Math.cos(s) * Math.cos(o) * Math.cos(n)
      ),
      l = Math.acos(
  ...
  (vt.inverse = function (t, e, a) {
    var n = e[0] * yt,
      ...
      o = a[0] * yt,
      i = Math.asin(
        Math.sin(n) * Math.sin(o) + Math.cos(n) * Math.cos(o) * Math.cos(s)
      ),
      l = (
          ...
          if (k(n, e))
            if (k(t, e) && null !== t[e])
              if (null === n[e] || n[e].constructor != Object) r[e] = t[e];
                ...
                r[e] = {};
                for (a in n[e])
                  k(t[e], a) ? (r[e][a] = t[e][a]) : (r[e][a] = n[e][a]);
              }
            else r[e] = n[e];
        return (
    ...
    _t = function () {
      ...
      function a() {
        ...
        if (
          ...
          ((o > 0.8 && i < Math.PI / 3) || o > 1) &&
            ((n = i / Math.abs(1 - o)),
            n * n > 6 * Math.abs(1 - o) &&
              (n = i < Math.PI ? Math.pow(6 * i, 1 / 3) : jt.asinh(i / o)),
            (t = n)),
      ...
      function r() {
        ...
        t.hasOwnProperty("w") || (t.w = t.W - t.N),
          ...
          1 !== t.e
            ...
            : ((t.w0 = 3 / Math.sqrt(2) / (t.q * Math.sqrt(t.q / y))),
              (t.a = 0),
              (t.t0 = 0)),
      ...
      function i() {
        var t = M.ephemeris,
          ...
          r =
            0.666 *
            ((1 - n / Math.PI) * Math.cos(n) + (1 / Math.PI) * Math.sin(n));
        return (
          1 * M.H +
      ...
      elements: function (t) {
        var e = (t.jd - 2451545) / 36525,
          ...
          l =
            ...
            2.2 *
              Math.cos(
                yt * (357.5291 + 35999.0503 * e - 1.536 * s + 0.041 * o + 0 * i)
              ) -
            2 *
              Math.cos(
                yt *
          ...
          p =
            ...
            45e-6 *
              Math.cos(
                yt *
                  (49.1562 - 75869.812 * e + 35.458 * s + 4.231 * o - 2.001 * i)
              ) +
            44e-6 *
              Math.cos(
                yt *
          ...
          z =
            ...
            0.00202 *
              Math.sin(
                yt * (355.0582 + 71998.1006 * e - 3.072 * s + 0.082 * o + 0 * i)
              ) +
            0.00167 *
              Math.sin(
                yt *
          ...
          .on("zoomstart", function () {
            ...
            d && (f = d),
              v.call(g, "zoom", function () {
                ...
                var a = d3.mouse(this),
                  l = r(f, e(u, a));
                u.rotate((M.r = o((i = l ? n(i, l) : n(t(u, s, a), i))))),
                  (s = a),
      ...
      return (
        ...
        (g.projection = function (t) {
          return arguments.length
            ? ((u = t), (M = { r: u.rotate(), k: u.scale() }), g.scale(M.k))
            : u;
        }),
          ...
          t.each(function () {
            ...
            if (r !== t) {
              r.each("start.zoom", function () {
                this.__chart__ &&
                  ((M = this.__chart__),
                  M.hasOwnProperty("r") || (M.r = u.rotate())),
